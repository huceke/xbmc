...
if [ "$USE_BUILDROOT" = "1" ]; then
  BUILDROOT=/media/usbdisk/xbmc/xbmc-samsung/buildroot-samsung
  TARBALLS=/media/usbdisk/xbmc/xbmc-samsung/xbmc-tarballs
  XBMCPREFIX=/media/usbdisk/xbmc/xbmc-samsung/xbmc-bin
